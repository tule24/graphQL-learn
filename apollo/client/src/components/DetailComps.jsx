...
const DetailComps = ({ data }) => {
    const { author, description, length, modules, modulesCount, numberOfViews, thumbnail, title, id } = data?.track
    return (
            ...
            <div className='p-5 bg-slate-200 shadow-lg mt-10 w-3/4'>
                ...
                <div className='flex justify-between my-5 items-center border-y border-white py-3'>
                    <div className='flex flex-col'>
                        ...
                        <p className='flex items-center text-pink-500'><BsEye className='mr-2' /> {numberOfViews} views()</p>
                    ...
                    <Link to={`./modules`} className='px-4 py-2 bg-pink-500 flex items-center text-lg'><BsPlay size={30} />Start Track</Link>
                </div>

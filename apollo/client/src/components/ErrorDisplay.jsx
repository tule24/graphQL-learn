...
const ErrorDisplay = ({ name, message }) => {
    return (
        <section className="flex items-center h-full sm:p-16 dark:bg-gray-900 dark:text-gray-100 my-3">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center">
                ...
                <p className="text-3xl">Something wrong when fetch data 😭😭😭</p>
                <p className="text-3xl">ERROR-NAME: {name}</p>
                <p className="text-3xl">ERROR-MESSAGE: {message}</p>
